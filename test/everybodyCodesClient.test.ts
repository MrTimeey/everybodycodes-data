...
describe("EverybodyCodesClient", () => {
    ...
    it("events", async () => {
        ...
        api
            ...
            .reply(200, JSON.stringify({ seed: "55" }), { headers: { "content-type": "application/json" } })
            .persist();

        api
            .intercept({ path: "/api/event/2024/quest/1", method: "GET" })
            .reply(200, JSON.stringify({ key1: DUMMY_KEY_1, key2: DUMMY_KEY_2 }), { headers: { "content-type": "application/json" } })
            .persist();

        cdn
            .intercept({ path: "/assets/2024/1/input/55.json", method: "GET" })
            .reply(200, JSON.stringify({ "1": ENCRYPTED_PART_1, "2": ENCRYPTED_PART_2 }), { headers: { "content-type": "application/json" } })
            .persist();
